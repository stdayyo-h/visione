...
import { ChatBubbleOutline, FolderSharedOutlined, TaskAltOutlined } from "@mui/icons-material";
const Manager_DashBoard = () => {
  ...
  useEffect(() => {
    getProjects().then(() => {console.log("Fetched the project")});
    getSkills().then(()=>{console.log("Fetched the Skills")});
  ...
  let getSkills = async () => {
    ...
    for(let i in data)
    {
      ...
      if(!unique_skills.includes(data[i].skill_name.split("-")[0]+"-"+data[i].skill_name.split("-")[1]))
      {
        
        unique_skills.push(data[i].skill_name.split("-")[0]+"-"+data[i].skill_name.split("-")[1]);
  ...
  let postData=(skills)=>{
    axios.post(`${BASE_URL}/recommended`,{'skills':skills}).then((response)=>{
                ...
                <div className="px-8">
                    ...
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            ...
                            <div className="py-1 px-3 rounded text-gray-500 flex items-center justify-center text-xs">5</div>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                <TaskAltOutlined/>
                            ...
                            <div className="py-1 px-3 rounded text-gray-500 flex items-center justify-center text-xs">8</div>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
...
<CalendarTodayOutlinedIcon/>
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            ...
                            <div className="py-1 px-3 rounded text-gray-500 flex items-center justify-center text-xs">25</div>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
            ...
            <div className="w-64 z-40 absolute shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out" id="mobile-nav">
                <div className="h-10 w-10 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer" id="mobile-toggler" onclick="sidebarHandler()">
                ...
                <div className="px-8">
                    ...
                    <div className="flex justify-center mt-48 mb-4 w-full">
                        <div className="relative ">
                            ...
                            <input className=" focus:outline-none rounded w-full text-sm text-gray-500 pl-10 py-2" type="text" placeholder="Search" />
                        </div>
                    </div>
                </div>
                <div className="px-8">
    ...
    <div className="w-full justify-center my-12">
        <div className=" top-40 bg-white shadow rounded py-12 lg:px-28 px-8 border">
            <p className="md:text-3xl text-xl font-bold text-center text-gray-700">Add project</p>
            <div className="md:flex items-center mt-12">
                <div className="md:w-72 flex flex-col">
                    <label className="text-base font-semibold leading-none text-gray-800">Project Name</label>
                    <input tabIndex={0} type="name" className="text-base leading-none text-gray-900 p-3 focus:oultine-none mt-4 border rounded border-gray-200" value={currentJob} onChange={(e)=>{setCurrentJob(e.target.value)}}/>
                    
                </div>
                <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                    <label className="text-base font-semibold leading-none text-gray-800">Project Description</label>
                    <input tabIndex={0} type="name" className="text-base leading-none text-gray-900 p-3 focus:oultine-none mt-4 border rounded border-gray-200" />
                </div>
            </div>     
            ...
            <div class="flex flex-row ">
              {
                ...
                skills.map((e,index)=>{
                  ...
                  <SkillBox skill_name={e} setSkillsArray={setSkillsArray} index={index}></SkillBox>
                  );
                })
              }
                ...
                <button className="btn m-2" onClick={ButtonClicked}>Get Employees</button>
                {
                employeeArray.map((e)=>{
                  console.log(e);
                  return <div className="flex flex-col justify-center"><EmployeeCard className="p-2" e={e} ></EmployeeCard>
                  <button className='bg-indigo-700 rounded-lg p-2 m-2' onClick={()=>{sendMail(e.employee_name,e.email,currentJob)}}>Confirm</button>
                  </div>
                })
              }
